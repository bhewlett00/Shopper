...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public String getShoppingListName(int id){
        ...
        //create SQL String that get the shopping list name
        String query = "SELECT * FROM " + TABLE_SHOPPING_LIST + " WHERE " + COLUMN_LIST_ID + " = " + id;

        //executing the select statement and store the result in a cursor
        ...
        if(cursor.getString(cursor.getColumnIndex("name")) != null){
            //store it in String that will be returned by the method
